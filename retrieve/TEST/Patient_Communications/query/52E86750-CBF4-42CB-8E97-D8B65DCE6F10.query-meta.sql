SELECT DISTINCT
    Account.EPIC_medicalrecordnumber__c AS EpicMRN_CNet,
    ...
    Account.Name AS FullName_CNet,
    List.PATIENT AS FullName_List,
...
FROM
    ENT.Imported_List_CTCAMRNs_for_Targeting_PtOfferings List
    LEFT JOIN ENT.Contact_Salesforce Contacts ON List.MRN = Contacts.ctca_medicalrecordnumber__c
