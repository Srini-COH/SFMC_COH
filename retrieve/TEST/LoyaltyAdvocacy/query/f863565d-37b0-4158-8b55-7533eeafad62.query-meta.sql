SELECT DISTINCT
    ...
    Contacts.CF_Member_Created_Date__c AS CFJoinDate,
...
FROM
    ENT.CL_Upload_for_Email_Match Invitees
    LEFT JOIN ENT.Contact_Salesforce Contacts ON Invitees.Email = Contacts.email
