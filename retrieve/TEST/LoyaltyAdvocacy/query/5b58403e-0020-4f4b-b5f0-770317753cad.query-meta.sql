SELECT
    ...
    WeeklyEvents.ContactID AS JourneyBookID
FROM
    ENT.CancerFighter_Patients_DE AS Contact
    INNER JOIN [JourneyBook_Chicago] AS WeeklyEvents ON Contact.Email = WeeklyEvents.Email
WHERE
