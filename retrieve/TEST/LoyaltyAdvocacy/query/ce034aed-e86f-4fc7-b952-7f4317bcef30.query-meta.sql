...
FROM
    ...
    INNER JOIN ENT.CL2020_Atlanta_InviteList Invitees ON Contacts.ctca_medicalrecordnumber__c = Invitees.MRN
    INNER JOIN ENT.Facilities__c_Salesforce Facility ON Contacts.prm_primaryfacility__c = Facility.Id
