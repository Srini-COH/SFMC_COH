...
FROM
    ...
    INNER JOIN ENT.Contact_Salesforce Contacts ON (
        List.New_MRN = Contacts.ctca_medicalrecordnumber__c
        OR List.Original_MRN = Contacts.ctca_medicalrecordnumber__c
    )
