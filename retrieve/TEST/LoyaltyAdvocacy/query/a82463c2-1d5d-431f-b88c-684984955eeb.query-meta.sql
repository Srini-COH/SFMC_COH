/*Employers_Partners_Target_Audience_DE
Used for Employer Relations communications where audience is Employer Partners (Aggregator,Broker,Carrier/Payer,TPA) */
SELECT
    c.Id AS [ContactId],
    c.Email AS [Email],
...
WHERE
    ...
    AND a.Type IN ('Aggregator', 'Broker', 'Carrier/Payer', 'TPA')
