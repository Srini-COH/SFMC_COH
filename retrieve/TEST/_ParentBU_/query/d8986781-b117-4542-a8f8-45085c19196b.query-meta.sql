SELECT DISTINCT
    ...
    /*Consider adding:
    Earliest DateSent where J.JourneyName ='Appointment Scheduled' as FirstSendDate
    Latest DateSent where J.JourneyName ='Appointment Scheduled' as LastSendDate
    TopicName on row with Latest DateSent where J.JourneyName ='Appointment Scheduled' as LastTopicSent*/
FROM
