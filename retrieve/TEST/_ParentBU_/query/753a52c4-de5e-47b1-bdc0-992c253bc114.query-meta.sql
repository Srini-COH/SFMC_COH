SELECT DISTINCT
    ...
    /*Consider adding:
    Earliest DateSent where J.JourneyName ='Insurance Approved' as FirstSendDate
    Latest DateSent where J.JourneyName ='Insurance Approved' as LastSendDate
    TopicName on row with Latest DateSent where J.JourneyName ='Insurance Approved' as LastTopicSent*/
FROM
