SELECT DISTINCT
    ...
    /*Consider adding:
    Earliest DateSent where J.JourneyName ='Appointment Kept' as FirstSendDate
    Latest DateSent where J.JourneyName ='Appointment Kept' as LastSendDate
    TopicName on row with Latest DateSent where J.JourneyName ='Appointment Kept' as LastTopicSent*/
FROM
