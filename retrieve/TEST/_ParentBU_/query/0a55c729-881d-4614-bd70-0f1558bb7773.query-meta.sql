SELECT DISTINCT
    ...
    Appt.ApptDate AS ApptDate,
    /*(Appt.ctca_1stTxDate) as '1stTxDate',*/
    Appt.ApptStatus AS ApptStatus,
...
FROM
    ...
    INNER JOIN [ALL_AppointmentKeptFY22_DE] Appt ON ObjOpportunity.Id = Appt.OpportunityId
...
WHERE
    ...
    AND Tx.CTCA1stTxDate >= '2021-07-01'
    AND Tx.CTCA1stTxDate < '2021-10-01'
