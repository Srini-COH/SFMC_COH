...
FROM
    ...
    LEFT JOIN [Contact_Salesforce] Contacts ON ObjOpportunity.ContactId__c = Contacts.Id
...
WHERE
    ...
    AND (
        ...
        /*this next date should be set to the latest CLOSED month*/
        OR FV.ctca_apptdate__c <= '2020-06-30'
    )
    AND FV.ctca_apptdate__c >= '2019-07-01'
    AND FV.ctca_apptdate__c <= '2020-06-30'
