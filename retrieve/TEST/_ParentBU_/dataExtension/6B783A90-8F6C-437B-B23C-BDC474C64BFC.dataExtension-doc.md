## 6B783A90-8F6C-437B-B23C-BDC474C64BFC

**Name** (not equal to External Key)**:** Announcement_ScheduledPatients

**Description:** list of ALL future scheduled patients regardless of when scheduled
